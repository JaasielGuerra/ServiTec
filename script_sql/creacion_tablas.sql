...
CREATE TABLE IF NOT EXISTS `db_servitec`.`orden` (
  ...
  `imagen_referencia` BLOB NULL COMMENT 'se guarda la ruta de una imagen que se guarda como referencia de lo que se recibe al momento de reservar la orden',
  ...
  `costo_repuestos` DOUBLE NULL,
  `costo_servicios` DOUBLE NULL,
